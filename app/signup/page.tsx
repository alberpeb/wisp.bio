  ...
  return (
    <div className="flex items-center flex-col mx-auto w-full justify-center pt-16 px-8">
      <Image
        ...
        height={96}
      />
      <h1 className="font-bold mt-1 text-2xl text-gray-700">Welcome! Sign up in the link below :)</h1>
      {data.linklogin.map((link) => (
        <LinkCard key={link.href} {...link} />
      ))}
      <h1 className="font-bold mt-1 text-2xl text-gray-700">Or you can Log in</h1>
